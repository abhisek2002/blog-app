...
function Contact() {
  ...
  const onSubmit = async (data) => {
    const userInfo = {
      access_key: "9d821455-bb71-47fb-8c36-9c1d774c87dc",
      name: data.username,
      email: data.email,
            ...
            <div className="w-full md:w-1/2 md:pl-4">
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-2">
                  ...
                  <span>+91 9693314965</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaEnvelope className="text-pink-500" />
                  <span>abhisek20022008@gmail.com</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaMapMarkerAlt className="text-green-500" />
                  <span>Blogora Office, New Delhi, India - 110011</span>
                </li>
              </ul>
            </div>
          </div>
